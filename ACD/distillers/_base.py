...
class Distiller(nn.Module):
    ...
    def get_learnable_parameters(self):
        ...
        return [(k, v) for k, v in self.teacher.named_parameters()]
    ...
    def get_base_flops(self, resolution):
        ...
        macs, _ = get_model_complexity_info(self.teacher, image_size, as_strings=True, print_per_layer_stat=False, verbose=True)
...
class Vanilla(nn.Module):
    ...
    def get_base_flops(self, resolution):
        ...
        # # 计算 FLOPs
        # flops = FlopCountAnalysis(self.student, input_tensor)
