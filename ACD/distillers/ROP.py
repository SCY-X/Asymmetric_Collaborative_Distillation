...
def rank_order_preservation(student_features, teacher_features, topk, temperature, rank_weight): 
    ...
    teacher_indicator_matrix = sigmoid(teacher_similarity_diff, temperature)  # Tensor shape: B x topk x topk
...
class ROP(Distiller):
    ...
    def forward_train(self, image, kd_student_image, kd_teacher_image, target, kd_target, **kwargs):
        ...
        kd_feature_loss = self.kd_loss_weight * rank_order_preservation(kd_feature_student["retrieval_feat"],
