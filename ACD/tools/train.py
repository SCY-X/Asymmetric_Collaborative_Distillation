...
def main(cfg, student_train_loader, distillation_loader, num_classes, query_loader, gallery_loader):
    ...
    if torch.cuda.device_count() > 1:
        ...
        base_flops = distiller.module.get_base_flops(cfg.INPUT.SIZE_TRAIN)
    else:
    ...
    print("The teacher base parameters: {:.3f} M, Extra parameters of {}: {:.3f} M, and base flops: {:<8}\033[0m".format(
