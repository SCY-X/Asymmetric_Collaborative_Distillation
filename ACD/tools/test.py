...
import sys
sys.path.append(os.path.abspath("XXXX/ACD"))
...
if __name__ == "__main__":
    ...
    if cfg.DISTILLER.TYPE == "NONE":
        model_student = model_dict[cfg.DISTILLER.STUDENT_NAME](pretrained=False, pretrained_path=cfg.DISTILLER.STUDENT_PRETRAIN_PATH, 
